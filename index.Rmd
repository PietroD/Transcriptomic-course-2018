...
### Manipolazione delle reads grezze e controllo qualità
...
Per effettuare queste due operazioni useremo un unico programma che si chiama **Trimmomatic**. Il suo utilizzo è molto simile a quello di FastQC (anche Trimmomatic è scritto in Java) e ha bisogno come input delle sequenze grezze
